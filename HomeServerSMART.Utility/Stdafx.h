...
// Version Information
#define PRODUCT_NAME			_T("Home Server SMART 2012")
#define PRODUCT_SHORT_NAME		_T("HS2")
#define PRODUCT_VERSION			_T("2.2.2.23")
#define PRODUCT_RELEASE			_T("2/1/2012")
#define PRODUCT_COPY_YEAR		_T("2010-2012")
#define PRODUCT_COPYRIGHT		_T("Copyright (C) 2012 Dojo North Software")
